const CACHE = 'poly-play-v3';
const APP_FILES = ['./poly-play.html', './poly-play.webmanifest', './assets/css/poly-play.css', './assets/js/poly-play.js', './poly-play-programacao.json', './catalogo.json'];
